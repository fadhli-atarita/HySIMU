HSIBLUR_WIN MATLAB Python Package
...
2. Installing the HSIBLUR_WIN Package

A. Change to the directory that contains the file setup.py and the subdirectory 
HSIBLUR_WIN. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the HSIBLUR_WIN Package

The HSIBLUR_WIN package is on your Python path. To import it into a Python script or 
session, execute:
